...
{
    BOOST_CHECK_EQUAL(JZ_SHORT_SOURCE_LOCATION, "throw.test.cpp:15"); // if this line number changes, the string will need to change too
}

BOOST_AUTO_TEST_CASE(test_throw)
{
    BOOST_CHECK_THROW(jz_throw("foo"), std::runtime_error);
